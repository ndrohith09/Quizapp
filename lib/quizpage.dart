...
class getjson extends StatelessWidget {
  ...
  setasset() {
    if (langname == "Ajanta Ellora") {
      assettoload = "assets/ajantha_ellora.json";
    } else if (langname == "Fatehpur Sikri") {
      assettoload = "assets/Fatehpur_sikri.json";
    } else if (langname == "Humayuns Tomb") {
      assettoload = "assets/Humayun's_Tomb.json";
    } else if (langname == "India Gate") {
      assettoload = "assets/India_gate.json";
    } else if (langname == "Mysore Palace") {
      assettoload = "assets/mysore_palace.json";
    } else {
      assettoload = "assets/naladana_university.json";
    }
  }
